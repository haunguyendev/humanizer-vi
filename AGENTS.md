...
- **Pattern:** skill hiện định nghĩa **28 pattern đánh số** (chia 5 nhóm A–E). Nếu thêm/bớt/đánh số lại pattern nào, cập nhật đồng thời: bảng pattern trong README, số "N pattern" ở heading, và mọi tham chiếu chéo trong cùng một lần sửa. Giữ số ổn định trừ khi cố ý đánh số lại.
